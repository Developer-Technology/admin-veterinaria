...
export class AddComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.breadCrumbItems = [
      ...
      { label: 'Historias', link: '/histories' },
  ...
  onSubmit(): void {
    ...
    if (this.newHistory.history_date) {
      this.newHistory.history_date = this.utilitiesService.formatToDateString(this.newHistory.history_date);
    }
